      ...
      switch (name) {
        ...
        case "gr_comp_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "HCC (Hellenic Competition Commission) MCP server. Provides access to German competition law enforcement decisions, merger control cases, and sector enforcement data under the Law 3959/2011 on the Protection of Free Competition.",
