...
[![npm version](https://badge.fury.io/js/%40ansvar%2Fgreek-competition-mcp.svg)](https://www.npmjs.com/package/@ansvar/greek-competition-mcp)
[![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![CI](https://github.com/Ansvar-Systems/greek-competition-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/Ansvar-Systems/greek-competition-mcp/actions/workflows/ci.yml)
...
**Endpoint:** `https://mcp.ansvar.eu/greek-competition/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add greek-competition-mcp --transport http https://mcp.ansvar.eu/greek-competition/mcp` |
...
```json
{
  "mcpServers": {
    "greek-competition-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/greek-competition/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/greek-competition-mcp
```
...
```json
{
  "mcpServers": {
    "greek-competition-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/greek-competition-mcp"]
    }
  }
}
```
...
| Tool | Description |
|------|-------------|
| `gr_comp_search_decisions` | Full-text search across HCC (Hellenic Competition Commission) enforcement decisions (abuse of dominance, cartel, sect... |
| `gr_comp_get_decision` | Get a specific HCC decision by case number (e.g., |
| `gr_comp_search_mergers` | Search HCC merger control decisions. Returns merger cases with acquiring party, target, sector, and outcome. |
| `gr_comp_get_merger` | Get a specific HCC merger control decision by case number. |
| `gr_comp_list_sectors` | List all sectors with HCC enforcement activity, including decision counts and merger counts per sector. |
| `gr_comp_about` | Return metadata about this MCP server: version, data source, coverage, and tool list. |
